...
public class RequestFoodToDonor extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_request_food_to_donor);
    ...
    private void submitRequest() {
        ...
        //add to db
        DatabaseReference ref = FirebaseDatabase.getInstance().getReference("Credentials").child(name).child("ReceiverRequestForFood");
        ref.child(timestamp).setValue(hashMap)
                .addOnSuccessListener(new OnSuccessListener<Void>() {
                    @Override
                    public void onSuccess(Void aVoid) {
                        //order info added now add order items
                        Toast.makeText(getApplicationContext(), " Food Request send Successfully...", Toast.LENGTH_SHORT).show();
                ...
                .addOnFailureListener(new OnFailureListener() {
                    ...
                    public void onFailure(@NonNull Exception e) {
                        ...
                        Toast.makeText(getApplicationContext(), "Food Request Fail...", Toast.LENGTH_SHORT).show();
                    }
                });
    }
}