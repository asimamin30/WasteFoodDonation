...
public class DonorRequestResponseActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_donor_request_response);
    ...
    private void LoadFoodRequestFromReceiver() {
        ...
        //get all shops
        DatabaseReference reference = FirebaseDatabase.getInstance().getReference("Credentials").child(name).child("ReceiverRequestForFood");
        reference.orderByChild("userType").equalTo("Receiver")
                .addValueEventListener(new ValueEventListener() {
                    ...
                    public void onDataChange(@NonNull DataSnapshot snapshot) {
                        ...
                        //setup adapter
                        requestResponseFromDonorAdapter = new RequestResponseFromDonorAdapter(DonorRequestResponseActivity.this,rcFoodReqModels);
