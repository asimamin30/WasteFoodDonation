...
public class ResponseAdapter extends RecyclerView.Adapter<ResponseAdapter.HolderShop> {

    private Context context;
    public ArrayList<RcFoodReqModel> rcFoodReqModels;

    public ResponseAdapter(Context context, ArrayList<RcFoodReqModel> rcFoodReqModels) {
    ...
    @NonNull
    @Override
    public ResponseAdapter.HolderShop onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
        //inflate layout row_shop.xml
        View view = LayoutInflater.from(context).inflate(R.layout.custom_food_req_from_rec,parent,false);


        return new ResponseAdapter.HolderShop(view);
    }

    @Override
    public void onBindViewHolder(@NonNull ResponseAdapter.HolderShop holder, int position) {
        //get data
