...
public class DonorProfiles extends AppCompatActivity {

    private SharedPreferences loginPreferences;
    private RecyclerView rcvRv;
    private ArrayList<DonorModel> donorList;
    private GetDonorProfiles getDonorProfiles;
    String Username;

    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        setContentView(R.layout.activity_donor_profiles);
        ...
        reference.orderByChild("userType").equalTo("Donor")
                .addValueEventListener(new ValueEventListener() {
                    ...
                    public void onDataChange(@NonNull DataSnapshot snapshot) {
                        ...
                        //setup adapter
                        getDonorProfiles = new GetDonorProfiles(DonorProfiles.this,donorList);
                        //set adapter to recyclerview
                        rcvRv.setAdapter(getDonorProfiles);
                    }
