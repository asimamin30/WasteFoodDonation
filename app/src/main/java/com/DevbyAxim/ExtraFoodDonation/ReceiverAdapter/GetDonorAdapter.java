...
public class GetDonorAdapter extends RecyclerView.Adapter<GetDonorAdapter.HolderShop> {

    private Context context;
    public ArrayList<DonorModel> donorlist;

    public GetDonorAdapter(Context context, ArrayList<DonorModel> donorlist) {
    ...
    @NonNull
    @Override
    public GetDonorAdapter.HolderShop onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
        //inflate layout row_shop.xml
        View view = LayoutInflater.from(context).inflate(R.layout.custom_receiver, parent, false);


        return new GetDonorAdapter.HolderShop(view);
    }

    @Override
    public void onBindViewHolder(@NonNull GetDonorAdapter.HolderShop holder, int position) {
        //get data
